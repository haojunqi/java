...
public class ItemCatController {
	...
	public PageResult findParentId(int page, int rows,Long parentId){
			return  itemCatService.findByParId(page,rows,parentId);
	}

	@RequestMapping("/selectItemCatList1")
	public List selectItemCatList1(Long parentId){
		return itemCatService.selectItemCatList1(parentId);
