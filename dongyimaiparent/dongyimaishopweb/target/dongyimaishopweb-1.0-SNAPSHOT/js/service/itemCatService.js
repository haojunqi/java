...
app.service('itemCatService',function($http){
	...
	this.findByParentId=function (page,rows,parentId){
		return $http.get('../itemCat/findParentId.do?page='+page+"&rows="+rows+"&parentId="+parentId)
	}
	this.selectItemCat1=function (parentId){
		return $http.get('../itemCat/selectItemCatList1.do?parentId='+parentId)
	}
});