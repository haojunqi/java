				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom">
								<#if (imageList?size >0)>
								<img jqimg="${imageList[0].url}" src="${imageList[0].url}" width="410" height="410"/>
								</#if>
							</span>
						</div>
						<!--下方的缩略图-->
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<dd>
									<a href="javascript:;"
									   class="{{isSelectes('${spec.attributeName}','${value}')?'selected':''}}"
									   ng-click="addspec('${spec.attributeName}','${value}')">${value}
							...
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										...
										<a href="javascript:void(0)" ng-click="addCateNum(1)" class="increment plus">+</a>
										<a href="javascript:void(0)"  ng-click="addCateNum(-1)" class="increment mins">-</a>
									</div>
								</div>
							</div>
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="#" ng-click="addCat()" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
