...
app.controller('typeTemplateController' ,function($scope,$controller   ,brandService,specificationService,typeTemplateService){
	...
	$scope.select2SpecList=function (){
		specificationService.select2SpecList().success(
			function (response){
	...
	$scope.selectInit=function (){
		$scope.select2BrandList();
		$scope.select2SpecList()
	}

	$scope.addTableRow=function (){
		$scope.entity.customAttributeItems.push({});
	}
	$scope.deleTbaleRow=function (index){
